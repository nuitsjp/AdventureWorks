...
${nuget_cmd} install src/AdventureWorks.EmployeeManager/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/AdventureWorks.EmployeeManager.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/AdventureWorks.EmployeeManager.dll \
-recurse:'src/AdventureWorks.EmployeeManager/*.cs' \
-doc:bin/AdventureWorks.EmployeeManager.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/AdventureWorks.EmployeeManager.dll was created successfully"
fi
